...
export class ProjectIndexService {
  ...
  getProjects() {
    ...
    // return this.http.get('http://camp-fire.herokuapp.com/projects', {headers: headers, params: {categoryTitle: categoryTitle}})
    return this.http.get('http://camp-fire.herokuapp.com/projects', {headers: headers})
